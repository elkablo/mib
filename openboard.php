...
if (($abc[type]=="formib" && $h->ok=="ok") || ($abc[type]=="forall" && $h->ok!="ok")) {
...
echo "<table width=\"550\"><tr><td><table><tr><td width=\"30%\"><b>$mailx$zaznam[author]$maily</b></td><td width=\"70%\">Pridané: ".generate_date($zaznam[id],"sec")."</td></tr></table></td></tr><tr><td><font class=\"text\">$zaznam[text]</font></td></tr></table>";
$mailx="";$maily="";
}
echo "<center>";
